...
class Core extends Component {
  ...
  checkAnswer = (index, correctAnswer, answerSelectionType, question) => {
    ...
    this.renderMessageforCorrectAnswer(question.imageAfter, question.imageTextAfter)
  ...
  renderTags(answerSelectionType, numberOfSelection) {
    ...
    return (
      <div className="tag-container">
        ...
        { showNextQuestionButton &&
              <button  style={{display: "inline-block", marginBottom:"0px"}} onClick={() => this.nextQuestion(currentQuestionIndex)} className="nextQuestionBtn btn">{nextQuestionBtn}</button>
        }
      </div>
      )
  }
