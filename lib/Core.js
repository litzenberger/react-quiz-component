...
function (_Component) {
  ...
  function Core(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderMessageforCorrectAnswer", function (image) {
      ...
      _this.setState({
        image: "<h3 dangerouslySetInnerHTML=".concat(_this.rawMarkup(image), "/> || ").concat(defaultMessage, ";")
      });
  ...
  _createClass(Core, [{
    ...
    value: function render() {
      ...
      }), this.renderTags(answerSelectionType, question.correctAnswer.length), this.renderAnswers(question, buttons), this.renderMessageforCorrectAnswer(question.imageBefore), _react.default.createElement("h3", {
        dangerouslySetInnerHTML: this.state.image
