...
function (_Component) {
  ...
  function Core(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkAnswer", function (index, correctAnswer, answerSelectionType, question) {
      ...
      _this.renderMessageforCorrectAnswer(question.imageAfter);

      _this.renderTextforCorrectAnswer(question.imageTextAfter);
