...
function (_Component) {
  ...
  _createClass(Core, [{
    ...
    value: function render() {
      ...
      }), this.renderTags(answerSelectionType, question.correctAnswer.length), this.renderAnswers(question, buttons), showNextQuestionButton && _react.default.createElement("div", null, _react.default.createElement("button", {
        onClick: function onClick() {
