...
function (_Component) {
  ...
  function Core(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderMessageforCorrectAnswer", function (question) {
      ...
      return _react.default.createElement("h3", {
        dangerouslySetInnerHTML: _this.rawMarkup(question.imageAfter)
      }) || defaultMessage;
    });
  ...
  _createClass(Core, [{
    ...
    value: function render() {
      ...
      }), this.renderTags(answerSelectionType, question.correctAnswer.length), this.renderAnswers(question, buttons), _react.default.createElement("h3", {
        dangerouslySetInnerHTML: this.rawMarkup(question.imageBefore)
