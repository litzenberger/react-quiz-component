...
function (_Component) {
  ...
  _createClass(Core, [{
    ...
    value: function renderTags(answerSelectionType, numberOfSelection) {
      ...
      }, pickNumberOfSelection.replace("<numberOfSelection>", numberOfSelection)), showNextQuestionButton && _react.default.createElement("div", {
        style: {
    ...
    value: function render() {
      ...
      }), this.renderTags(answerSelectionType, question.correctAnswer.length), this.renderAnswers(question, buttons), !correctAnswer && !incorrectAnswer && this.renderMessageforCorrectAnswer(question.imageBefore), this.renderImage()), endQuiz && showDefaultResult && customResultPage == null && _react.default.createElement("div", {
        className: "card-body"
