...
function (_Component) {
  ...
  function Core(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkAnswer", function (index, correctAnswer, answerSelectionType) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderMessageforCorrectAnswer", function (image) {
      var defaultMessage = 'You are correct. Please click Next to continue.';

      _this.setState({
        image: "".concat(image, " || ").concat(defaultMessage)
      });
  ...
  _createClass(Core, [{
    ...
    value: function renderTags(answerSelectionType, numberOfSelection) {
      var pickNumberOfSelection = this.props.appLocale.pickNumberOfSelection;
      return _react.default.createElement("div", {
    ...
    value: function renderImage() {
      return _react.default.createElement("h3", {
        dangerouslySetInnerHTML: this.rawMarkup(this.state.image)
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, (correctAnswer || incorrectAnswer) && showInstantFeedback && _react.default.createElement("div", {
        className: "alert correct"
      }, this.renderMessageforCorrectAnswer(question.imageAfter), this.renderExplanation(question, false))), _react.default.createElement("div", null, appLocale.question, " ", currentQuestionIndex + 1, ":"), _react.default.createElement("h3", {
        dangerouslySetInnerHTML: this.rawMarkup(question.question)
      }), this.renderTags(answerSelectionType, question.correctAnswer.length), this.renderAnswers(question, buttons), this.renderMessageforCorrectAnswer(question.imageBefore), this.renderImage(), showNextQuestionButton && _react.default.createElement("div", null, _react.default.createElement("button", {
        onClick: function onClick() {
