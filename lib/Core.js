...
function (_Component) {
  ...
  function Core(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkAnswer", function (index, correctAnswer, answerSelectionType, image) {
      console.log(image);

      _this.renderMessageforCorrectAnswer(image);
      ...
      return answers.map(function (answer, index) {
        if (buttons[index] != undefined) {
          ...
          return _react.default.createElement("button", {
            key: index,
            onClick: function onClick() {
              return _this.checkAnswer(index + 1, correctAnswer, answerSelectionType, question.imageAfter);
            },
  ...
  _createClass(Core, [{
    ...
    value: function renderImage() {
      var style = {
        animation: _reactAnimation.animations.popIn
      };
    ...
    value: function render() {
      ...
      }), this.renderTags(answerSelectionType, question.correctAnswer.length), showNextQuestionButton && _react.default.createElement("div", null, _react.default.createElement("button", {
        onClick: function onClick() {
          return _this2.nextQuestion(currentQuestionIndex);
        },
        className: "nextQuestionBtn btn"
      }, appLocale.nextQuestionBtn)), this.renderAnswers(question, buttons), !correctAnswer && !incorrectAnswer && this.renderMessageforCorrectAnswer(question.imageBefore), this.renderImage()), endQuiz && showDefaultResult && customResultPage == null && _react.default.createElement("div", {
        className: "card-body"
